...
const CaseProposalList = () => {
  const { proposals, loading, loadingProposals, acceptProposal } =
    useProposalList();
          ...
          <Paper key={item.id} fullHeight fullWidth>
              ...
              <div className="flex space-x-5 w-full">
                    ...
                    <Tooltip
                      triggerEl={
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <Text customClasses="font-semibold">
                ...
                <div>
                  <div className="py-2 px-6 bg-primary-700 rounded-full shadow-sm shadow-primary-300">
                    <Text variant={TextVariant.BODY2} bolded color="text-white">
                      {item.price} $
                    </Text>
                  </div>
                </div>
            ...
            <div className="py-5">
              <Text>
                ...
                fugiat quis voluptas nihil ratione optio nobis esse voluptatem
                hic dolorum.
              </Text>
            </div>
